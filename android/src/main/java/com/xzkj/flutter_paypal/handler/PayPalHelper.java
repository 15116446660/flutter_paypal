...
public class PayPalHelper {
    ...
    //DEBUG
    //AWKVk40mTA3Ry7V-SXht9w-xTAKtS1CKpuz-rLEVQ9usVBAABEICCL7IsSuuFNWq8b8qMJtQEsisIC5b

    //release
    //AeGDuFVe9gwDkMdCSaY9NKsp9rv_Ja8afbuHNRbd_NAnoe1oTN08r8p7rWoM-jnAIh9fR2iDUGyDgWHC

    //本地测试
    //AWEUGyu2IFSRc0uMAgUGBPcX5CJmq8emfft7uiDjuJdeGbtFQH2KUMwavhEabtajcf5W_c0QwKnWIVvP

    //你所注册的APP Id
    private static final String CONFIG_RELEASE_ID = "AeGDuFVe9gwDkMdCSaY9NKsp9rv_Ja8afbuHNRbd_NAnoe1oTN08r8p7rWoM-jnAIh9fR2iDUGyDgWHC";
    //DEBUG APP ID
    private static final String CONFIG_DEBUG_ID = "AWKVk40mTA3Ry7V-SXht9w-xTAKtS1CKpuz-rLEVQ9usVBAABEICCL7IsSuuFNWq8b8qMJtQEsisIC5b";
